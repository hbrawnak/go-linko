...
func (res *Response) ReadJSON(w http.ResponseWriter, r *http.Request, data any) error {
...
func (res *Response) WriteJSON(w http.ResponseWriter, status int, data any, headers ...http.Header) error {
...
func (res *Response) ErrorJSON(w http.ResponseWriter, err error, status ...int) error {
	...
	return res.WriteJSON(w, statusCode, payload)
}
